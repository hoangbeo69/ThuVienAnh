 ...
 * @author HiHi
 */
public class DangNhapWork {

    private String taiKhoan;
    private String matKhau;
    private Socket socket;

    public DangNhapWork(Socket socket, String taiKhoan, String matKhau) {
    ...
    private boolean sendDataCheck(String data) {
        try {
            ...
            Logger.getLogger(DangNhapWork.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
